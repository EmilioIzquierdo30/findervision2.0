...
recetas = [
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f320d"),  # Espinaca de Malabar
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f320e"),  # Menta
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f320f"),  # Quelite Verde
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3210"),  # Reemplaza con el _id correspondiente a Moringa
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3211"),  # ID correspondiente a Karanda
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3212"),  # ID correspondiente al Árbol Peepal
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3213"),  # ID correspondiente a la Granada
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3214"),  # ID correspondiente al Jazmín
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3215"),  # ID correspondiente a la Guayaba
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3216"),  # ID correspondiente a Neem
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3217"),  # ID correspondiente al Mango
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3218"),  # ID correspondiente a Rasna
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3219"),  # ID correspondiente a Betel
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321a"),  # ID correspondiente a Menta Mexicana
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321b"),  # ID correspondiente a la Adelfa
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321c"),  # ID correspondiente al Jamun
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321d"),  # ID correspondiente a Indian Beech
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321e"),  # ID correspondiente a la Yaca
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f321f"),  # ID correspondiente a la Mostaza India
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3220"),  # ID correspondiente a Crape Jasmine
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3221"),  # ID correspondiente al Limón
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3222"),  # ID correspondiente a la Manzana Rosa
        ...
        {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3223"),  # ID correspondiente a la Higuera Roxburgh
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3224"),  # ID correspondiente al Árbol de Curry
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3225"),  # ID correspondiente a Rosa de China
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3226"),  # ID correspondiente a Parijata
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3227"),  # ID correspondiente a Jamaica Cherry
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3228"),  # ID correspondiente a Tulsi
        "titulo": "Té de Tulsi",
        ...
        {
        "planta_id": ObjectId("6747e7ddfda8eac9011f3229"),  # ID correspondiente a Sándalo
    ...
    {
        "planta_id": ObjectId("6747e7ddfda8eac9011f322a"),  # ID correspondiente al Fenogreco
